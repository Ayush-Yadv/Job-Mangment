...
const DEFAULT_TEMPLATES: JobTemplate[] = [
  {
    ...
    requirements: ['3+ years experience', 'React & Node.js', 'Database design', 'RESTful APIs'],
    responsibilities: ['Design web apps', 'Write clean code', 'Collaborate with team', 'Code reviews'],
    benefits: ['Competitive salary', 'Remote-first', 'Health insurance', 'Learning budget'],
  ...
  },
  {
    ...
    requirements: ['4+ years design experience', 'Figma expert', 'Strong portfolio', 'Design systems'],
    responsibilities: ['Create prototypes', 'User research', 'Design system', 'Collaborate'],
    benefits: ['Flexible hours', 'Creative environment', 'Conferences', 'Equipment allowance'],
    createdAt: '2025-12-01'
  },
  {
    id: 'tpl-3',
    ...
    requirements: ['5+ years DevOps', 'AWS/GCP/Azure', 'Kubernetes/Docker', 'Terraform'],
    responsibilities: ['CI/CD pipelines', 'Cloud infrastructure', 'Monitoring', 'Automation'],
    benefits: ['Competitive pay', 'Remote work', 'Certifications', 'Stock options'],
    createdAt: '2025-12-01'
  },
];
  ...
  const getAvailableActions = (job: Job) => {
    ...
    switch (job.status) {
      case 'draft':
        ...
        actions.push({ label: 'Edit', icon: <Edit className="w-4 h-4" />, onClick: () => { setEditingJob(job); setShowJobEditor(true); setActionMenuJob(null); } });
        break;
      case 'published':
    ...
    actions.push({ label: 'View History', icon: <Clock className="w-4 h-4" />, onClick: () => { setSelectedJobForHistory(job); setActionMenuJob(null); } });
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-6 py-3 text-center text-sm font-medium text-gray-700 w-20">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              {filteredJobs.map(job => (
                <tr key={job.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4">
                    {/* Fixed Actions Column - Center aligned */}
      ...
      {selectedJobForHistory && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-6 z-50">
          <div className="bg-white rounded-2xl max-w-lg w-full">
            ...
            <div className="p-6">
              <p className="text-gray-600 mb-4">{selectedJobForHistory.title}</p>
              <div className="space-y-4">
